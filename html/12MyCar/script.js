...
let car, wheel, background
  ...
  car = {};
  car.image = new Image();
  car.image.src = "img/car.png";
  car.pos = 0;
  car.speed = 2;

  wheels = {};
wheels.backWheel = new Image()
wheels.backWheel.src = "img/wheel.png";

wheels.frontWheel = new Image()
wheels.frontWheel.src = "img/wheel.png";
...
car.image.addEventListener ('load',()=>{
  wheels.backWheel.width = 100;
  wheels.backWheel.height = 100;
  wheels.frontWheel.width = 100;
  wheels.frontWheel.height = 100;
